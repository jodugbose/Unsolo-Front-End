        ...
        <section className='chatbox-container-main'>
          <div className="div-container">
            ...
            <div className="right-menu" onClick={handleChatView}>
              <box-icon name='chevron-down' size="lg" color='#ffffff' animation="tada-hover" ></box-icon>
            </div>
          </div>
          ...
          <div className="chat-view">
                ...
                messages?.map((msg, index) => {
                  ...
                  return (
                    <div key={index} 
                      ...
                      className={`${sender === 'You' ? 'sender' : sender === menu ? 'menu-items' : 'bot' }`}>
                      <li id="chat-bubble" 
                      className={`${sender === 'You' ? 'sender-style' : sender === menu ? 'menu-items-style' : 'bot-style' }`}> {message} </li>
                    </div>
                  )
                })
              }
            ...
            <div className="input">
              <input type="text" name="message" value={senderInput}
                placeholder='Type a message and press enter'
                id="message" className="message-input"
                onChange={handleMessageInput} onKeyDown={sendMessageKeyDown} />
            </div>
          </div>
        </section> :
